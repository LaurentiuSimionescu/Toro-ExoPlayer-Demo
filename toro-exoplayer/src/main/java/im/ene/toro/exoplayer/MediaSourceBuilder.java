...
public interface MediaSourceBuilder {
    ...
    MediaSourceBuilder DEFAULT = new MediaSourceBuilder() {
        ...
        public MediaSource buildMediaSource(@NonNull Context context, @NonNull Uri uri,
            ...
            mediaDataSourceFactory = ((ExoPlayerApplication) context.getApplicationContext()).buildDataSourceFactory();
                ...
                case C.TYPE_HLS:
                    result = new HlsMediaSource.Factory(mediaDataSourceFactory)
                            .setPlaylistParserFactory(
                                    new DefaultHlsPlaylistParserFactory(((ExoPlayerApplication) context.getApplicationContext()).getDownloadTracker().getOfflineStreamKeys(uri)))
                            .createMediaSource(uri);
                    break;
                case C.TYPE_OTHER:
